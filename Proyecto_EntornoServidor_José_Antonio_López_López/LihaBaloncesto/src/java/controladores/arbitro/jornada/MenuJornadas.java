 ...
 * @author Zatonio
 */
@WebServlet(name = "MenuJornadasArbitro", urlPatterns = {"/arbitro/MenuJornadas"})
public class MenuJornadas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = "/arbitro/jornadas/menuJornadas.jsp";
        ...
        LigaJpaController lc = new LigaJpaController(emf);

        Liga liga = lc.findLiga(idLiga);
        request.setAttribute("liga", liga); //Mandamos la liga y jornada a la vista
        request.setAttribute("jornadas", liga.getJornadas());
