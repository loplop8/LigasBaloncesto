 ...
 * @author Zatonio
 */
@WebServlet(name = "ImportarDatosJornada", urlPatterns = {"/arbitro/ImportarDatosJornada"})
public class ImportarDatosJornada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Long idJornada = Long.valueOf(idJornadaStr);
