 ...
 * @author Zatonio
 */
@WebServlet(name = "BorrarEquipo", urlPatterns = {"/admin/BorrarEquipo"})
public class BorrarEquipo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ujc.destroy(Long.valueOf(request.getParameter("id")));
            response.sendRedirect("MenuEquipos");
        } catch (NonexistentEntityException ex) {
            Logger.getLogger(BorrarEquipo.class.getName()).log(Level.SEVERE, null, ex);
        }
